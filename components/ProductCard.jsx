                ...
                <div className="text-right">
                    ...
                    {product.mrp && product.mrp > product.price && (
                        <div className="flex flex-col">
                            <p className="text-xs text-gray-500 line-through">{currency}{product.mrp}</p>
                            <p className="text-xs text-[#38b6ff]">-{Math.round((product.mrp - product.price) / product.mrp * 100)}%</p>
                        </div>
                    )}
                </div>
            </div>
